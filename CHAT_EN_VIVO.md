...
| # | Pendiente | Detalle |
|---|---|---|
| 1 | ~~**Timezone incorrecto en timestamps**~~ ✅ RESUELTO | `ENV TZ=America/Mexico_City` agregado en `Dockerfile`. Afectaba `LocalDateTime.now()` en BD y timestamps del JSON. Corregido en dev y qa el 2026-06-18. |
