...
SELECT s.id, 'escanear-codigo', 'Escanear código de barras (📷)',
       'Botón 📷 del buscador y botón "Escanear código de barras" de vista móvil, en Tienda. Abre la cámara para buscar por código. No afecta a visitantes sin cuenta -- solo aplica a cuentas con sesión.',
       'Buscador', 12
FROM submenu s
